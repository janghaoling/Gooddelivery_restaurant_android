...
import com.gooddelivery.restau.model.Address;
import com.gooddelivery.restau.model.Invoice;
import com.gooddelivery.restau.model.Order;
import com.gooddelivery.restau.model.Shop;
import com.gooddelivery.restau.model.Transporter;
import com.gooddelivery.restau.model.User;
        ...
        if (order != null) {
            ...
            if (order.getStatus() != null) {
                if (order.getStatus().equalsIgnoreCase(context.getString(R.string.completed)))
                    holder.shopName.setText(context.getString(R.string.completed));
                else if (order.getStatus().equalsIgnoreCase(context.getString(R.string.cancelled)))
                    holder.shopName.setText(context.getString(R.string.cancelled));
                else
